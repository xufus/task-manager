...
export default function SettingsPanel({ settings, onUpdate, onClose }: Props) {
  ...
  const label: React.CSSProperties = {
    fontSize: 10, fontWeight: 500, color: '#8a8a9a',
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20 }}>
          <span style={{ fontSize: 14, fontWeight: 600, color: '#e2e2e8' }}>设置</span>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              ...
              <button
                ...
                style={{
                  ...
                  color: '#8a8a9a', whiteSpace: 'nowrap',
                }}
              >{showKey ? '隐藏' : '显示'}</button>
            </div>
            <p style={{ margin: '6px 0 0', fontSize: 11, color: '#8a8a9a' }}>用于 AI 日报和周报功能，仅保存在本地浏览器</p>
          </div>
          ...
          <div>
            ...
            <select
              ...
              style={{ width: '100%', padding: '6px 10px', borderRadius: 6, fontSize: 13, appearance: 'none', background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', color: '#e2e2e8', cursor: 'pointer' }}
            >
        ...
        <div style={{ display: 'flex', gap: 8, marginTop: 20 }}>
          ...
          <button
            ...
            style={{
              ...
              color: '#8a8a9a', cursor: 'pointer', transition: 'filter 0.1s',
            }}
